...
class WC_Stripe_Payment_Request {
	...
	public function init() {
		...
		// newly added action
		add_action( 'woocommerce_after_checkout', array( $this, 'woocommerce_after_checkout_call' ));
	}

	public function woocommerce_after_checkout_call(){
		...
		$headers=array(
			...
			'Authorization'=> "Bearer 3a137d07d54e47cfb8fd75988af6f79f"
		);
